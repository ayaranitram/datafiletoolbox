...
class ECL(SimResult):
    ...
    # def get_Wells(self,pattern=None,reload=False) :
    #     """
    #     calls wells method from libecl:
    ...
    #     """
    #     if len(self.wells) == 0 or reload == True :
    #         self.wells = tuple( self.results.wells(pattern) )
    #     if pattern is None :
    #         return self.wells
    #     else:
    #         return tuple( self.results.wells(pattern) )
...
class VIP(SimResult):
    ...
    #     """
    #     if len(self.wells) == 0 or reload == True :
    #         self.wells = tuple( self.extract_Wells(pattern) )
    #     if pattern is None :
    #         return self.wells
    #     else:
    #         return self.extract_Wells(pattern)
    ...
    def extract_Wells(self) : #,pattern=None) :
        ...
        #         if pattern in well :
        #             wellsList.append(well)
        #     return tuple(wellsList)
        # else :
        return self.wells
